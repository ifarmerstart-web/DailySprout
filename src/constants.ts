...
export const MASTER_CROPS: MasterCrop[] = [
  // --- 기존 봄 작물 ---
  {
    ...
    basePlantDay: 5,
    growthDays: 75,
    image: 'https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/sprout.svg',
  ...
  },
  {
    ...
    basePlantDay: 5,
    growthDays: 120,
    image: 'https://images.unsplash.com/photo-1604430456280-43f652c497aa?auto=format&fit=crop&q=80&w=400',
