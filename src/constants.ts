...
export const MASTER_CROPS: MasterCrop[] = [
  ...
  },
  {
    ...
    basePlantDay: 15,
    growthDays: 90,
    image: 'https://images.unsplash.com/photo-1591954840042-46a869bc3673?auto=format&fit=crop&q=80&w=400',
    description: '배수가 매우 중요하며 햇빛이 잘 드는 건조한 곳을 좋아합니다.',
    tempInfo: { germination: '15~20 °C', growth: '18~25 °C', characteristic: '과습에 매우 취약함' },
  ...
  },
  {
    ...
    basePlantDay: 1,
    growthDays: 50,
    image: 'https://images.unsplash.com/photo-1618376168193-909282292994?auto=format&fit=crop&q=80&w=400',
    description: '고온을 좋아하는 대표적인 여름 허브입니다. 추위에 매우 약합니다.',
    tempInfo: { germination: '20~25 °C', growth: '25~30 °C', characteristic: '15 °C 이하에서는 성장이 멈춤' },
